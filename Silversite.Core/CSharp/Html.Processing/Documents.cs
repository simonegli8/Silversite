...
namespace Silversite.Html {
	...
	public class Document : Container {
		...
		public int CurrentKey { get { return this.All<Element>(e => e.Attributes["ContentKey"] != null).Count(); } }
		...
		public static Document Open(Page page) {
			Document doc = page.Items["ss:PageSource"];
			if (doc == null) doc = Open(page.AppRelativeVirtualPath);
			if (doc != null) doc.Control = page;
			page.Items["ss:PageSource"] = doc;
			return doc;
		}
