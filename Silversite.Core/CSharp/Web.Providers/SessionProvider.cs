...
namespace Silversite.Web.Providers {
	...
	*/
	[Table("Silversite_Web_Providers_Session")]
	...
	[Table("Silversite_Web_Providers_SessionCleanup")]
...
namespace Silversite.Web {
	...
	/// </summary>
	public class SilversiteSessionStateStore: SessionStateStoreProviderBase {
		string connectionString;
		ConnectionStringSettings connectionStringSettings;
		string eventSource = "SilversiteSessionStateStore";
