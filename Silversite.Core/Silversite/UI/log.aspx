<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="log.aspx.cs" Inherits="Silversite.Web.UI.LogPageBase" ClassName="Silversite.Web.UI.LogPage" MasterPageFile="~/Silversite/Master/xhtml5.master" %>
...
<asp:Content ContentPlaceHolderID="body" runat="server">
	...
	<asp:Panel runat="server" ID="LogContainer" CssClass="LogContainer">
		...
		<table style="width:600;" border="0" class=".headtable">
			<tr>
