...
namespace Silversite {
	...
	public static class TypeExtensions {
		...
		public static bool Implements(this Type type, Type _interface, bool inherit) { return Services.Types.Implements(type, _interface, inherit); }
		public static bool Implements(this Type type, Type _interface) { return Services.Types.Implements(type, _interface); }
		public static string InvariantName(this Type type) { return Services.Types.InvariantName(type); }
